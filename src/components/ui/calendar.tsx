  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-600 text-white hover:bg-blue-700 hover:text-white focus:bg-blue-700 focus:text-white dark:bg-blue-800 dark:text-primary-foreground dark:hover:bg-blue-900 dark:hover:text-primary-foreground dark:focus:bg-blue-900 dark:focus:text-primary-foreground",
        day_today:
          "bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-50",
        day_outside: "day-outside text-gray-400 opacity-50 dark:text-gray-500",
